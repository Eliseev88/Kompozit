...
$(document).ready(function () {
    $(".slider").slick({
        ...
        prevArrow:
            '<button id="prev" type="button" class="slick-arrow slick-prev"><i class="fas fa-arrow-left"></i></button>',
        nextArrow:
            '<button id="next" type="button" class="slick-arrow slick-next"><i class="fas fa-arrow-right"></i></button>',
...
$(document).ready(function () {
    $(".gallery__slider").slick({
        ...
        prevArrow:
            '<button id="prev" type="button" class="gallery__arrow gallery__arrow--left"><i class="fas fa-chevron-circle-right"></i></button>',
        nextArrow:
            '<button id="next" type="button" class="gallery__arrow gallery__arrow--right"><i class="fas fa-chevron-circle-left"></i></button>',
        centerMode: true,
        centerPadding: "40px",
        slidesToShow: 3,
...
function countTentRoof(a, b, h, d1, d2) {
    ...
    let cornicePlank = Math.ceil(
        (a + a + b + b + d1 + d1 + d2 + d2 + d1 + d1 + d2 + d2) / 2
    );
    let windPlank = 0;
...
function countHipRoof(a, b, c, h, d1, d2) {
    ...
    let cSmall =
        a *
        ((Math.sqrt(Math.pow(h, 2) + Math.pow(c, 2)) + d1) /
    ...
    let trapSquare =
        (Math.sqrt(Math.pow(h, 2) + Math.pow(a / 2, 2)) + d2) *
        (b - 2 * c + Math.sqrt(Math.pow(triSide, 2) - Math.pow(heightTrap, 2)));
