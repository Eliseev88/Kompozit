        ...
        <div class="container">
            <div class="footer__inner">
                <nav class="footer__nav">
                    ...
                    <div class="footer__nav-el">
                        <a class="footer__nav-link" href="#" data-scroll="#video">Видео</a>
                    </div>
                    <div class="footer__nav-el">
                        <a class="footer__nav-link" href="#" data-scroll="#questions">Вопросы</a>
                    </div>
                    <div class="footer__nav-el">
                        <a class="footer__nav-link" href="#" data-scroll="#contacts">Контакты</a>
                    </div>
                </nav>
                    ...
                    <div class="footer__social-list">
                        <a href="https://instagram.com/kompozit.plast" target="_blank" class="footer__social-link">
                            ...
                            <svg class="footer__social-link-icon " fill="#000000" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path d="M37 11A2 2 0 1 0 37 15A2 2 0 1 0 37 11Z" /></svg>
                        </a>
                        ...
                        <a href="#" class="footer__social-link">
                            ...
                            <svg class="footer__social-link-icon " fill="#000000" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <polyline fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-miterlimit="10" stroke-width="2" points="15,30 39,14 22,34" />
                                <polyline fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-miterlimit="10" stroke-width="2" points="20,43 22,34 26,37" /></svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="footer__contacts">
                    <h4>телефон</h4>
                    <a class="footer__contacts-phone" href="tel:+7814332211">+7(495)197-88-60</a>
                </div>

                <div class="footer__address">
                    <h4>Наш адрес:</h4>
                    <p><b>Офис: </b>Москва, Кутузовский проспект, дом 36 стр. 3
                    </p>
                    <p><b>Склад: </b>Московская область, г.Истра, ул. Почтовая дом 31</p>
                </div>
